...
public class BadezimmerProdukt extends Produkt{
     ...
     */
    public BadezimmerProdukt(String seriennummer, String name, String beschreibung, Produkt kaufempfehlung, int jahrgang, int lieferzeit, int mengenbestand, double preis, boolean imAngebot) {
        super(seriennummer, "Badezimmer", name, beschreibung, kaufempfehlung, jahrgang, lieferzeit, mengenbestand, preis, imAngebot);
    }
}
