...
public class SchlafzimmerListe extends Verwaltungsliste<SchlafzimmerProdukt> {
    ...
    public SchlafzimmerProdukt produktErzeugen(String name, String beschreibung, Produkt kaufempfehlung, int jahrgang, int lieferzeit, int mengenbestand, double preis, boolean imAngebot) throws InvalidProductAttributeException {
